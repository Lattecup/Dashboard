...
const Instructions = () => {
  ...
  const downloadExample = () => {
    const exampleData = [
      ['Команда', 'Сквозной процесс', 'Этап ИФТ', 'Срок этапа', 'Шагов всего', 'Шагов выполнено', 'Проблема', 'Исполнитель', 'Срок проблемы', 'Тип проблемы'],
        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                ...
                <tr><td>Тип проблемы</td><td>блокер / критичный / обычный</td><td>блокер</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>Если у этапа нет проблемы — оставь колонки "Проблема", "Исполнитель", "Срок проблемы", "Тип проблемы" пустыми</li>
